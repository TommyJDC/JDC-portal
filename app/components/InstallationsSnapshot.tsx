...
import { faStore, faUtensils, faSmoking, faClipboardCheck } from "@fortawesome/free-solid-svg-icons";
...
export const InstallationsSnapshot: React.FC<InstallationsSnapshotProps> = ({ stats, isLoading = false }) => {
  if (isLoading) {
    return (
